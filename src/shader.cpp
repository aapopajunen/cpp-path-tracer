...
Shader::Shader(const std::string& fileName){
    ...
    checkShaderError(mProgram, GL_LINK_STATUS, true, "Error: Program failed to link: ");
    glValidateProgram(mProgram);
    checkShaderError(mProgram, GL_LINK_STATUS, true, "Error: Program failed to validate: ");
